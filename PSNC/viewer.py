...
npz_path = "PSNC/PSNCcase.npz"
vtk_path = "PSNC/PSNCcase.vtk"
...
if view_tab == "Digital Twin":
    ...
    if field_choice == "Temperature":
        ...
        field_max = 32.15  # Fixed upper limit for Temperature
        ...
        color_label = "|U| [m/s]"
        field_min = float(field.min())
        field_max = float(field.max())  # Free for U
        low_default = field_min
...
# -------------------------------------------------
    ...
    with col1:
        ...
        if mode == "3D Scatter":
            ...
            try:
                ...
                st.warning(f"Outer geometry (PSNC/PSNCcase.vtk) could not be loaded: {e}")  
    ...
    with col2:
        ...
        if field_choice == "Temperature":
            ...
            # Fixed Peak Temperature for PSNC: 32.05
            peak_value = 32.05
        else:  # Airflow Velocity
